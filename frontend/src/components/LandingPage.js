        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl transition-transform duration-300 group-hover:scale-105">
                  <img 
                    src="https://images.unsplash.com/photo-1758600432914-2b5f4483c7b8?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHw0fHxmcmllbmRseSUyMHByb2Zlc3Npb25hbHxlbnwwfHx8fDE3NjE1NzU3MzR8MA&ixlib=rb-4.1.0&q=85"
                    alt="Connect with me on Instagram"
                    className="w-full h-96 object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-purple-900/80 via-purple-900/40 to-transparent flex items-end justify-center pb-8">
                    <div className="text-center">
                      <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                        ...
                        <span className="font-semibold text-gray-900">@wael_abdeldayem_loan_officer</span>
                      </div>
                      <p className="text-white font-medium mt-4 text-lg">👋 Click to Follow!</p>
                    </div>
                  </div>
                </div>
              </a>
