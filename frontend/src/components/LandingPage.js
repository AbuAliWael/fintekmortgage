...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="bg-gradient-to-br from-purple-50 to-pink-50 py-2">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-1">
            <h3 className="text-xl font-bold text-gray-900 mb-1">Follow Me on Instagram</h3>
            <p className="text-sm text-gray-600">Stay updated with mortgage tips, market insights, and success stories</p>
          </div>
          <div className="flex justify-center transform scale-50 origin-top -mt-4 -mb-48">
            <div 
